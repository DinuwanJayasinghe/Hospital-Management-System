...
DROP TABLE IF EXISTS `admin_user_details`;
...
LOCK TABLES `admin_user_details` WRITE;
/*!40000 ALTER TABLE `admin_user_details` DISABLE KEYS */;
INSERT INTO `admin_user_details` VALUES ('stanneshospitalplc@gmail.com','2703700','2703700');

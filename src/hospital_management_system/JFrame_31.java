 ...
 */
public class JFrame_31 extends javax.swing.JFrame {
    ...
    private void jButton_PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PrintActionPerformed
        ...
        try {
            ...
            Logger.getLogger(JFrame_31.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        jTextArea1.append("\t\t ST. ANNE'S HOSPITAL(pvt).Ltd - Sri Lanka \n\n"
                + "\t\t\t    Patirnt Details \n\n"
                +"" + JFrame_7.jLabel_Time.getText() + "\t\t\t\t\t"  + JFrame_7.jLabel_Date.getText() +"\n\n"
                + "\t\t    ====================================================================\n\n"
                + "Patient ID  : \t\t\t\t" + JFrame_7.jTextField_Patient_ID.getText() + "\n\n"
                + "Admited Date : \t\t\t\t" + JFrame_7.jDateChooser_Addmited_Date1.getDate() + "\n\n"
                + "Name of Patient : \t\t\t" + JFrame_7.jTextField_Ptn_Name.getText() + "\n\n"
                + "Name of Doctor : \t\t\t" + JFrame_7.jTextField_Doc_Name.getText() + "\n\n"
                + "Date of Birth : \t\t\t" + JFrame_7.jDateChooser_DOB.getDate() + "\n\n"
                + "Gender : \t\t\t\t" + JFrame_7.jComboBox_Gender.getSelectedItem() + "\n\n"
                + "Telephone Number : \t\t\t" + JFrame_7.jTextField_Tel_No1.getText() + "\n\n"
                + "Relation's Name : \t\t\t" + JFrame_7.jTextField_Relation_Name.getText() + "\n\n"
                + "Relation's Contact Number : \t\t" + JFrame_7.jTextField_Relation_Phone_No.getText() + "\n\n"
                + "Address : \t\t\t\t" + JFrame_7.jTextField_Address.getText() + "\n\n"
                + "About Patient : \t\t\t" + JFrame_7.jTextArea_About.getText() + "\n\n"
                + "\t\t===============Thank You!================\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_31.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

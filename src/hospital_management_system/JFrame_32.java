 ...
 */
public class JFrame_32 extends javax.swing.JFrame {
    ...
    private void jButton_PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PrintActionPerformed
        ...
        try {
            ...
            Logger.getLogger(JFrame_32.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        jTextArea1.append("\t\t ST. ANNE'S HOSPITAL(pvt).Ltd - Sri Lanka \n\n"
                + "\t\t\tDischarged Patirnt Details \n\n"
                + "" + JFrame_16.jLabel1_Time.getText() + "\t\t\t\t\t" + JFrame_16.jLabel_Date.getText() + "\n\n"
                + "\t\t    ====================================================================\n\n"
                + "Discharged ID  : \t\t\t" + JFrame_16.PID_TB.getText() + "\n\n"
                + "Patient Name : \t\t\t\t" + JFrame_16.P_Name_TB1.getText() + "\n\n"
                + "Doctor's Name : \t\t\t" + JFrame_16.D_Name_TB1.getText() + "\n\n"
                + "Datr of Last Checked : \t\t\t" + JFrame_16.jDateChooser_Date_Of_Checked.getDate() + "\n\n"
                + "Telephone Number : \t\t\t" + JFrame_16.Tel_No.getText() + "\n\n"
                + "Address : \t\t\t\t" + JFrame_16.Address.getText() + "\n\n"
                + "\t\t===============Thank You!================\n"
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_32.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
